...
<head>
    ...
    <title>uMod - Инджектор/Инспектор/Экстрактор текстур для игр</title>
            ...
            <div class="row" id="mediacontent">
                ...
                <div id="content" class="col-f">
                    <div class="inner">
                        ...
                        <div class="PosterMaterials" style="background-image: url(/main/posters/poster7.jpg);">
                            <div class="title">
                                <h1>uMod - Инджектор/Инспектор/Экстрактор текстур для игр</h1>
                            </div>
                            <div class="meta">
                                <span class="pubdate">12.02.2020</span>
                                <a class="categories" href="/categories/makegame.php" class="categories"><img
                                        src="/main/windows2.svg" alt="">Создание игр</a>
                            </div>
                            <div id="action">
                                <ul class="list">
                        ...
                        <div id="descript">
                            <br></br>
                            <p>Universal Modding Engine - это программа, при помощи которой можно достать/заменить текстуры из любой 3D игры. Также работает с .tpf файлами, которые можно собирать программой TexMod.</p>
                        </div>
                        ...
                        <div id="download">
                            ...
                            <div class="dwrapper">
                                <a href="/download/uMod - ИнджекторИнспекторЭкстрактор текстур для игр.zip" download>
                                    <button class="download-start"><strong>СКАЧАТЬ</strong><small>Размер файла
                                            1.5МВ</small></button></a>

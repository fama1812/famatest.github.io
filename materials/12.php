...
<head>
    ...
    <title>PHP скрипт авторизации</title>
            ...
            <div class="row" id="mediacontent">
                ...
                <div id="content" class="col-f">
                    <div class="inner">
                        ...
                        <div class="PosterMaterials" style="background-image: url(/main/posters/poster8.jpg);">
                            <div class="title">
                                <h1>PHP скрипт авторизации</h1>
                            </div>
                            <div class="meta">
                                <span class="pubdate">12.02.2020</span>
                                <a class="categories" href="/categories/php.php" class="categories"><img
                                        src="/main/html2.svg" alt="">PHP/MySQL</a>
                            </div>
                            <div id="action">
                                <ul class="list">
                        ...
                        <div id="descript">
                            <p>Довольно простой готовый скрипт PHP для создания авторизации по готовым аккаунтам.</p>
                            <br>
                            
                            <p>Он будет полезен тогда, когда Вы продаете какие-то аккаунты.</p>
                            <br>
                            
                            <p>Под каждый аккаунт здесь можно указать собственный текст, который будет показываться авторизованному пользователю.</p>
                            <br> 
                            
                            <p>Пара логин/пароль для демо: demo1@demo.com/pass</p>
                        </div>
                        ...
                        <div id="download">
                            ...
                            <div class="dwrapper">
                                <a href="/download/php1.zip" download>

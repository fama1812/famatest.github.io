...
<head>
    ...
    <title>Switch.js - Чекбоксы как в iPhone!</title>
            ...
            <div class="row" id="mediacontent">
                ...
                <div id="content" class="col-f">
                    <div class="inner">
                        ...
                        <div class="PosterMaterials" style="background-image: url(/main/posters/poster9.jpg);">
                            <div class="title">
                                <h1>Switch.js - Чекбоксы как в iPhone!</h1>
                            </div>
                            <div class="meta">
                                <span class="pubdate">12.02.2020</span>
                                <a class="categories" href="/categories/javascript.php" class="categories"><img
                                        src="/main/html2.svg" alt="">JavaScript</a>
                            </div>
                            <div id="action">
                                <ul class="list">
                        ...
                        <div id="descript">
                            <p>Хотите заменить старые чекбоксы в HTML формах на крутые айфоновские?</p>
                        ...
                        <div id="download">
                            ...
                            <div class="dwrapper">
                                <a href="https://github.com/zhiyul/switch/archive/master.zip" download>
                                    <button class="download-start"><strong>СКАЧАТЬ</strong><small>С GitHub
                                            </small></button></a>

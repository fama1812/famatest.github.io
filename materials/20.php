...
<head>
    ...
    <title>Р. Лафоре - Объектно-ориентированное программирование в С++</title>
            ...
            <div class="row" id="mediacontent">
                ...
                <div id="content" class="col-f">
                    <div class="inner">
                        ...
                        <div class="PosterMaterials" style="background-image: url(/main/posters/poster17.jpg);">
                            <div class="title">
                                <h1>Р. Лафоре - Объектно-ориентированное программирование в С++</h1>
                            </div>
                            <div class="meta">
                                <span class="pubdate">12.02.2020</span>
                                <a class="categories" href="/categories/C.php" class="categories"><img src="/main/books.svg" alt="">C++</a>
                            </div>
                            <div id="action">
                                <ul class="list">
                                    <li style="padding-left: 10px;"><a class="ActionList" href="#descript"><img class="ActionListImg" src="/main/desc.png" alt="">ОПИСАНИЕ</a></li>

                                    <li class="dow"><a class="ActionListNone" href="#download"><img class="ActionListImg" src="/main/download2.png" alt="">СКАЧАТЬ</a>
                                    </li>
                        ...
                        <div id="descript">
                            <p>Благодаря этой книге тысячи пользователей овладели технологией объектно-ориентированного программирования в С++. В ней есть все: основные принципы языка, готовые полномасштабные приложения, небольшие примеры, поясняющие теорию, и множество полезных иллюстраций. Книга пользуется стабильным успехом в учебных заведениях благодаря тому, что содержит более 100 упражнений, позволяющих проверить знания по всем темам. Читатель может вообще не иметь подготовки в области языка С++. Необходимо лишь знание начальных основ программирования.</p>
                        </div>
                        ...
                        <div id="download">
                            ...
                            <div class="dwrapper">
                                <a href="/download/Роберт Лафоре Объектно-ориентированное программирование в C++, 4-е издание (2004).zip" download>

...
<head>
    ...
    <title>Девид Флэнаган — Javascript (5 издание)</title>
            ...
            <div class="row" id="mediacontent">
                ...
                <div id="content" class="col-f">
                    <div class="inner">
                        ...
                        <div class="PosterMaterials" style="background-image: url(/main/posters/poster18.jpg);">
                            <div class="title">
                                <h1>Девид Флэнаган — Javascript (5 издание)</h1>
                            </div>
                            <div class="meta">
                                <span class="pubdate">12.02.2020</span>
                                <a class="categories" href="/categories/javaskriptbook.php" class="categories"><img src="/main/books.svg" alt="">JavaScript</a>
                            </div>
                            <div id="action">
                                <ul class="list">
                        ...
                        <div id="descript">
                            <p>Пятое издание бестселлера "JavaScript. Подробное руководство" полностью обновлено. Рассматриваются взаимодействие с протоколом HTTP и применение технологии Ajax, обработка XML-документов, создание графики на стороне клиента с помощью тега "canvas", пространства имен в JavaScript, необходимые для разработки сложных программ, классы, замыкания, Flash и встраивание сценариев JavaScript в Java-приложения.</p>
                        </div>
                        ...
                        <div id="download">
                            ...
                            <div class="dwrapper">
                                <a href="/download/JavaScript. Подробное руководство. Дэвид Флэнаган.zip" download>

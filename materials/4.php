...
<head>
    ...
    <title>Шрифт - Suicide Squad из фильма Отряд Самоубийц</title>
            ...
            <div class="row" id="mediacontent">
                ...
                <div id="content" class="col-f">
                    <div class="inner">
                        ...
                        <div class="PosterMaterials" style="background-image: url(/main/posters/suicide.png);">
                            <div class="title">
                                <h1>Шрифт - Suicide Squad из фильма Отряд Самоубийц</h1>
                            </div>
                            <div class="meta">
                                <span class="pubdate">12.02.2020</span>
                                <a class="categories" href="/categories/font.php" class="categories"><img
                                        src="/main/photoshop2.svg" alt="">Шрифты</a>
                            </div>
                            <div id="action">
                                <ul class="list">
                        ...
                        <div id="descript">
                            <p>Необычный шрифт <span style="color: #b96ad9;">Suicide Squad</span>, для самых отвязных и безбашенных.</p>
                        </div>
                        ...
                        <div id="download">
                            ...
                            <div class="dwrapper">
                                <a href="/download/Suicide_Squad_Font.zip" download>

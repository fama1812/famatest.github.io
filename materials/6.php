...
<head>
    ...
    <title>Расширенная база часто используемых паролей, > 85 000 штук</title>
            ...
            <div class="row" id="mediacontent">
                ...
                <div id="content" class="col-f">
                    <div class="inner">
                        ...
                        <div class="PosterMaterials" style="background-image: url(/main/posters/poster1.jpg);">
                            <div class="title">
                                <h1>Расширенная база часто используемых паролей, > 85 000 штук</h1>
                            </div>
                            <div class="meta">
                                <span class="pubdate">12.02.2020</span>
                                <a class="categories" href="/categories/basedata.php" class="categories"><img
                                        src="/main/fire2.svg" alt="">Базы Данных</a>
                            </div>
                            <div id="action">
                                <ul class="list">
                        ...
                        <div id="descript">
                            <p>В этой базе Вы найдете невероятно огромное количество самых часто употребляемых паролей людьми по всему миру.</p> 
                            
                            <br></br>
                            <p>Очень полезная штука для проверки защищённости пароля. Или можно её использовать для Hashcat в качестве словаря, вот ссылка на <a href="1.php">статью</a></p>
                            
                            <br></br>
                            <p>А вдруг Ваш пароль в этом списке? :)</p>
                        </div>
